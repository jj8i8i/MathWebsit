// ===== SCRIPT.JS (FINAL & GUARANTEED WORKING VERSION) =====
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Event Listeners (THE FIX IS HERE) ---
    loginStuff.loginBtn.addEventListener('click', () => {
        ...
        if (credentials[username] && credentials[username] === password) {
            ...
            // Step 1: Switch the screen immediately.
            showScreen('test');
            
            // Step 2: Use a tiny delay (50ms) before running heavy tasks.
            // This gives the browser time to render the new screen first.
            setTimeout(() => {
                renderProblems();
                startTimer();
